...
{
    [System.Serializable]
    public class GraphEvent_GValue_GEquationGroupFloat : BluePrint_GroupFloat, IExpectedEquationReturnType, IEquationExposedHolder
    {
        public EEquationReturnType ExpectedReturnType => EEquationReturnType.GroupFloat;
        ...
        [EditorGraphProperty("GroupFloat", false, EditorGraphPropertyType.EEPT_GEquation)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            //try
            //{
            //    m_ReturnVal = m_GEquationVal.groupFloatValue(evalPart, _time);
            //}
            //finally
            //{
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_GValue_GEquationGroupFloat GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GEquationGroupFloat();
