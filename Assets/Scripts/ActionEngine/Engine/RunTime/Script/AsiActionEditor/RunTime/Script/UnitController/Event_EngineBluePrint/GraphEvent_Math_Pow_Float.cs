...
{
    [System.Serializable]
    public class GraphEvent_Math_Pow_Float : BluePrint_Float
    {
        ...
        #region Property
        [EditorGraphProperty("幂", true, EditorGraphPropertyType.EEPT_Float)]
        public BluePrint_Float BluePrint_Vector3
        {
            get { return m_BluePrint_Vector3; }
            set { m_BluePrint_Vector3 = value; }
        }
        [EditorGraphProperty("指数", true, EditorGraphPropertyType.EEPT_Float)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_ReturnVal = Mathf.Pow(BluePrint_Vector3.value, BluePrint_Vector32.value);
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_Pow_Float _graphEvent = null;
#endif
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Math_Pow_Float();
