...
namespace AsiActionEngine.RunTime.Graph
{
    [System.Serializable]
    //带参的Vector3
    public class GraphEvent_SetGValue_Enum : BluePrint_Int
    {

        [SerializeReference] protected BluePrint_Int m_ReadValue = new GraphEvent_Value_Int();
        [SerializeField] protected GEnum m_FloatVal = new GEnum();
        ...
        [EditorGraphProperty("GInt", false, EditorGraphPropertyType.EEPT_GEnum)]
        public GEnum FloatVal
        {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            if (!m_UnitVal.IsNode)
            {
                m_FloatVal.SetValue(part, (byte)m_ReturnVal);
            }
            else
            {
...
#endif
                m_FloatVal.SetValue(m_UnitVal.value.GetUnit().ActionStateMachine.FirstStatePart, (byte)m_ReturnVal);
            }
        }
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_SetGValue_Enum GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_SetGValue_Enum();
                GraphEventG.ReadValue = (BluePrint_Int)m_ReadValue.Clone();
                GraphEventG.FloatVal = (GEnum)m_FloatVal.Clone();
