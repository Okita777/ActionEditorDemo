...
namespace AsiActionEngine.RunTime.Graph
{
    [System.Serializable]
    //带参的Vector3
    public class GraphEvent_SetGValue_Bool : BluePrint_Bool
    {

        [SerializeReference] protected BluePrint_Bool m_ReadValue = new GraphEvent_Value_Bool();
        [SerializeField] protected GBool m_FloatVal = new GBool();
        [SerializeReference] protected BluePrint_Unit m_UnitVal = new GraphEvent_Value_SelfUnit();
        #region Property

        [EditorGraphProperty("ReadValue", true, EditorGraphPropertyType.EEPT_Bool)]
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_SetGValue_Bool GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_SetGValue_Bool();
                GraphEventG.ReadValue = (BluePrint_Bool)m_ReadValue.Clone();
                GraphEventG.FloatVal = (GBool)m_FloatVal.Clone();
