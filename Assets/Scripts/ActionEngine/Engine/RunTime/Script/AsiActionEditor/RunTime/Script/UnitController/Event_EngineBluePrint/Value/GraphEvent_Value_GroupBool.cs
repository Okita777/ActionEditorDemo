...
{
    [System.Serializable]
    public class GraphEvent_Value_GroupBool : BluePrint_GroupBool
    {
        [SerializeField] protected int m_ListLength;
        [System.NonSerialized] private List<bool> m_ListVal;
        ...
        public override List<bool> value => m_ListVal;
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_ListVal = EngineResourcesManager.Instance.CreateBools();
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Value_GroupBool _graphEvent = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Value_GroupBool();
