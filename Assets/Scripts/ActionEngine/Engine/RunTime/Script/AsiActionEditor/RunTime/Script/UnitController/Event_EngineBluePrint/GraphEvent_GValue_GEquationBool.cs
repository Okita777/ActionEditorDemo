...
{
    [System.Serializable]
    public class GraphEvent_GValue_GEquationBool : BluePrint_Bool, IExpectedEquationReturnType, IEquationExposedHolder
    {
        public EEquationReturnType ExpectedReturnType => EEquationReturnType.Bool;
        ...
        [EditorGraphProperty("Bool", false, EditorGraphPropertyType.EEPT_GEquation)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            //try
            //{
            //    m_ReturnVal = m_GEquationVal.boolValue(evalPart, _time);
            //}
            //finally
            //{
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_GValue_GEquationBool GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GEquationBool();
