...
{
    [System.Serializable]
    public class GraphEvent_LocalParam_Read_String : BluePrint_String
    {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_CachedValue = BluePrintLocalContext.GetString(m_ParamIndex);
        }

#if UNITY_EDITOR
        [System.NonSerialized] private GraphEvent_LocalParam_Read_String _graphEvent;
#endif
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_LocalParam_Read_String();
