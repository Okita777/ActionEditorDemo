...
{
    [System.Serializable]
    public class GraphEvent_NoValue_GroupString : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_GroupString m_BluePrint_Val = new GraphEvent_GValue_GGString();
        ...
        #region Property
        [EditorGraphProperty("GroupString", true, EditorGraphPropertyType.EEPT_GroupString)]
        public BluePrint_GroupString BluePrint_Val
        {
        ...
        public List<string> value(ActionStatePart part, ActionMachineTime _time)
        {
            part.ActionStateMachine.BluePrintClear();
        ...
        public GraphEvent_NoValue_GroupString Clone()
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_GroupString clone = new GraphEvent_NoValue_GroupString();
            clone.BluePrint_Val = (BluePrint_GroupString)m_BluePrint_Val.Clone();
