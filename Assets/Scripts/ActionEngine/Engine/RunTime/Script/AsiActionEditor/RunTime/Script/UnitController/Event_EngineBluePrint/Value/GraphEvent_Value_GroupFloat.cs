...
{
    [System.Serializable]
    public class GraphEvent_Value_GroupFloat : BluePrint_GroupFloat
    {
        [SerializeField] protected int m_ListLength;
        [System.NonSerialized] private List<float> m_ListVal;
        ...
        public override List<float> value => m_ListVal;
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_ListVal = EngineResourcesManager.Instance.CreateFloats();
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Value_GroupFloat _graphEvent = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Value_GroupFloat();
