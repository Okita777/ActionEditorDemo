...
{
    [System.Serializable]
    public class GraphEvent_NoValue_GroupBool : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_GroupBool m_BluePrint_Val = new GraphEvent_GValue_GGBool();
        ...
        #region Property
        [EditorGraphProperty("GroupBool", true, EditorGraphPropertyType.EEPT_GroupBool)]
        public BluePrint_GroupBool BluePrint_Val
        {
        ...
        public List<bool> value(ActionStatePart part, ActionMachineTime _time)
        {
        ...
        public GraphEvent_NoValue_GroupBool Clone()
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_GroupBool clone = new GraphEvent_NoValue_GroupBool();
            clone.BluePrint_Val = (BluePrint_GroupBool)m_BluePrint_Val.Clone();
