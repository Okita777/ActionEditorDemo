...
namespace AsiActionEngine.RunTime.Graph
{
    [System.Serializable]
    //带参的Vector3
    public class GraphEvent_GValue_GGUnit : BluePrint_GroupUnit
    {
        [SerializeField] protected GGroupUnit m_IntVal = new GGroupUnit();
        ...
        [EditorGraphProperty("GroupUnit", false, EditorGraphPropertyType.EEPT_GGroupUnit, LabelWidth = 60)]
        public GGroupUnit IntVal
        {
            get { return m_IntVal; }
            set { m_IntVal = value; }
        }
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_GValue_GGUnit GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GGUnit();
                GraphEventG.IntVal = (GGroupUnit)m_IntVal.Clone();
