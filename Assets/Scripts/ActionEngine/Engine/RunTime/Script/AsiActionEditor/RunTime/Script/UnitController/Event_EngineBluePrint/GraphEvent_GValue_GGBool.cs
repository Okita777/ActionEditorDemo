...
{
    [System.Serializable]
    public class GraphEvent_GValue_GGBool : BluePrint_GroupBool
    {
        [SerializeField] protected GGroupBool m_GroupVal = new GGroupBool();
        ...
        [EditorGraphProperty("GroupBool", false, EditorGraphPropertyType.EEPT_GGroupBool, LabelWidth = 60)]
        public GGroupBool GroupVal
        {
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_GValue_GGBool GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GGBool();
                GraphEventG.GroupVal = (GGroupBool)m_GroupVal.Clone();
