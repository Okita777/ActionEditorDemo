...
{
    [System.Serializable]
    public class GraphEvent_NoValue_Bool : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_Bool m_BluePrint_Val = null;
        ...
        public GraphEvent_NoValue_Bool(bool val = false)
        {
            m_BluePrint_Val = new GraphEvent_Value_Bool(val);
        }
        ...
        public bool value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_Bool clone = new GraphEvent_NoValue_Bool();
            clone.m_BluePrint_Val = (BluePrint_Bool)m_BluePrint_Val.Clone();
