...
{
    [System.Serializable]
    public class GraphEvent_Math_GroupSet_Unit : BluePrint_GroupUnit
    {
        ...
        [SerializeReference] protected BluePrint_Unit m_SetValue = new GraphEvent_Value_SelfUnit();
        ...
        [EditorGraphProperty("Value", true, EditorGraphPropertyType.EEPT_GUnit)]
        public BluePrint_Unit SetValue
        {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            if (idx >= 0 && idx < m_ReturnVal.Count && m_SetValue.isValid(part))
            {
                m_ReturnVal[idx] = m_SetValue.value.GetUnit();
            }
#if UNITY_EDITOR
            else if (idx < 0 || idx >= m_ReturnVal.Count)
            {
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_GroupSet_Unit GraphEventG = null;
#endif
