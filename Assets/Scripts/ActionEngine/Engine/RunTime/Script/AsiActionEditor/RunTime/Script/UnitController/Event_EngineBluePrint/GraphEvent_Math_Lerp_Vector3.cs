...
{
    [System.Serializable]
    public class GraphEvent_Math_Lerp_Vector3 : BluePrint_Vector3
    {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_B.Init(part, _time);
            m_T.Init(part, _time);
            m_ReturnVal = Vector3.Lerp(m_A.value, m_B.value, m_T.value);
        }

        public override Vector3 value => m_ReturnVal;

#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_Lerp_Vector3 GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_Lerp_Vector3();
