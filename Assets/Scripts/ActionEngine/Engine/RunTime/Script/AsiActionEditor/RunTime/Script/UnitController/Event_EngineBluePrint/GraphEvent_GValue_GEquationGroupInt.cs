...
{
    [System.Serializable]
    public class GraphEvent_GValue_GEquationGroupInt : BluePrint_GroupInt, IExpectedEquationReturnType, IEquationExposedHolder
    {
        public EEquationReturnType ExpectedReturnType => EEquationReturnType.GroupInt;
        ...
        [EditorGraphProperty("GroupInt", false, EditorGraphPropertyType.EEPT_GEquation)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            //try
            //{
            //    m_ReturnVal = m_GEquationVal.groupIntValue(evalPart, _time);
            //}
            //finally
            //{
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_GValue_GEquationGroupInt GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GEquationGroupInt();
