...
{
    [System.Serializable]
    public class GraphEvent_Math_RemoveAt_GroupFloat : BluePrint_GroupFloat
    {
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_RemoveAt_GroupFloat GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_RemoveAt_GroupFloat();
