...
namespace AsiActionEngine.RunTime.Graph
{
    [System.Serializable]
    //带参的Vector3
    public class GraphEvent_Math_DebugGValue_GroupUnit : BluePrint_GroupUnit
    {
        [SerializeReference] protected BluePrint_GroupUnit m_ReadValue = new GraphEvent_GValue_GGUnit();
        ...
        [EditorGraphProperty("ReadValue(GrouUnit)", true, EditorGraphPropertyType.EEPT_GGroupUnit, LabelWidth = 150)]
        public BluePrint_GroupUnit ReadValue
        {
        ...
        //public override void SetListSource(List<ActionEngine_Unit> _list)
        //{
        //    m_ReturnVal = _list;
        //}
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            foreach (ActionEngine_Unit u in m_ReturnVal)
            {
                Transform p = u.transform;
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_DebugGValue_GroupUnit GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_DebugGValue_GroupUnit();
                GraphEventG.ReadValue = (BluePrint_GroupUnit)m_ReadValue.Clone();
