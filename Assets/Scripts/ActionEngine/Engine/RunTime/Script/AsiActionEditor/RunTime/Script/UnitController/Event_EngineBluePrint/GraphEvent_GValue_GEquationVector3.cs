...
{
    [System.Serializable]
    public class GraphEvent_GValue_GEquationVector3 : BluePrint_Vector3, IExpectedEquationReturnType, IEquationExposedHolder
    {
        public EEquationReturnType ExpectedReturnType => EEquationReturnType.Vector3;
        ...
        [EditorGraphProperty("Vector3", false, EditorGraphPropertyType.EEPT_GEquation)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            //try
            //{
            //    m_ReturnVal = m_GEquationVal.vector3Value(evalPart, _time);
            //}
            //finally
            //{
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_GValue_GEquationVector3 GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GEquationVector3();
