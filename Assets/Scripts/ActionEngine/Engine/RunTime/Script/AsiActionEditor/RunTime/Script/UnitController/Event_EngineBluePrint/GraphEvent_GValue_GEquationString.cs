...
{
    [System.Serializable]
    public class GraphEvent_GValue_GEquationString : BluePrint_String, IExpectedEquationReturnType, IEquationExposedHolder
    {
        public EEquationReturnType ExpectedReturnType => EEquationReturnType.String;
        ...
        [EditorGraphProperty("String", false, EditorGraphPropertyType.EEPT_GEquation)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            //try
            //{
            //    m_ReturnVal = m_GEquationVal.stringValue(evalPart, _time);
            //}
            //finally
            //{
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_GValue_GEquationString GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_GValue_GEquationString();
