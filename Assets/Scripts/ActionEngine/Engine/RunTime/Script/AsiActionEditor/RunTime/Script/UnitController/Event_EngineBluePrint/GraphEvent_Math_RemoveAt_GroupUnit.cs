...
{
    [System.Serializable]
    public class GraphEvent_Math_RemoveAt_GroupUnit : BluePrint_GroupUnit
    {
        ...
        public BluePrint_GroupUnit ListVal
        {
            get { return m_InVal; }
            set { m_InVal = value; }
        }
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_RemoveAt_GroupUnit GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_RemoveAt_GroupUnit();
                GraphEventG.ListVal = (BluePrint_GroupUnit)m_InVal.Clone();
