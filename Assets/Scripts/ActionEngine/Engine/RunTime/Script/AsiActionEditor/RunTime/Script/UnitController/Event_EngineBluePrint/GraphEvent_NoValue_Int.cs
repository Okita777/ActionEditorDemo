...
{
    [System.Serializable]
    public class GraphEvent_NoValue_Int : INodeEdiDataHolder
    {
        ...
        public int value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_Int clone = new GraphEvent_NoValue_Int();
            clone.m_BluePrint_Val = (BluePrint_Int)m_BluePrint_Val.Clone();
