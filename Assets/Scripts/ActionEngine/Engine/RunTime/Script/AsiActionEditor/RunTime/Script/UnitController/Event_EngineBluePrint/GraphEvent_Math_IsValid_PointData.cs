...
{
    [System.Serializable]
    public class GraphEvent_Math_IsValid_PointData : BluePrint_Bool
    {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_ReturnVal = m_BluePrint_val_l.value.isValid;
        }

        public override bool value => m_ReturnVal;
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_IsValid_PointData _graphEvent = null;
#endif
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Math_IsValid_PointData();
