...
{
    [System.Serializable]
    public class GraphEvent_Math_Bool_Or : BluePrint_Bool
    {
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_Bool_Or _graphEvent = null;
#endif
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Math_Bool_Or();
