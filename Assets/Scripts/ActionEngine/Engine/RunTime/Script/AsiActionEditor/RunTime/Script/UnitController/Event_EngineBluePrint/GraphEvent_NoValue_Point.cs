...
{
    [System.Serializable]
    public class GraphEvent_NoValue_Point : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_PointData m_BluePrint_Val = null;
        ...
        public GraphEvent_NoValue_Point(BluePrint_PointData _value)
        {
            m_BluePrint_Val = _value;
        }
        public GraphEvent_NoValue_Point()
        {
            m_BluePrint_Val = new GraphEvent_BValue_Point();
        }
        #region Property
        [EditorGraphProperty("Point", true, EditorGraphPropertyType.EEPT_PointData)]
        ...
        public PointData value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_Point clone = new GraphEvent_NoValue_Point();
            clone.BluePrint_Val = (BluePrint_PointData)m_BluePrint_Val.Clone();
