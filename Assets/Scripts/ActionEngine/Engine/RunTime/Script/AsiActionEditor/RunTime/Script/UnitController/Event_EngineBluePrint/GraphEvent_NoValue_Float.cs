...
{
    [System.Serializable]
    public class GraphEvent_NoValue_Float : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_Float m_BluePrint_Val;
        ...
        public GraphEvent_NoValue_Float(float _value = 0)
        {
            m_BluePrint_Val = new GraphEvent_Value_Float(_value);
        }
        public GraphEvent_NoValue_Float(BluePrint_Float _value)
        {
        ...
        public float value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_Float clone = new GraphEvent_NoValue_Float();
            clone.m_BluePrint_Val = (BluePrint_Float)m_BluePrint_Val.Clone();
