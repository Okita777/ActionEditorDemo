...
{
    [System.Serializable]
    public class GraphEvent_Value_GroupString : BluePrint_GroupString
    {
        [SerializeField] protected int m_ListLength;
        [System.NonSerialized] private List<string> m_ListVal;
        ...
        public override List<string> value => m_ListVal;
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            m_ListVal = EngineResourcesManager.Instance.CreateStrings();
            for (int i = 0; i < count; i++)
            {
                m_ListVal.Add(string.Empty);
            }
        }

#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Value_GroupString _graphEvent = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Value_GroupString();
