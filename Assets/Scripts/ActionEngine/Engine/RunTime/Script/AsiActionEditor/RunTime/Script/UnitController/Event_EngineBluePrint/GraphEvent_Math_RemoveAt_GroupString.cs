...
{
    [System.Serializable]
    public class GraphEvent_Math_RemoveAt_GroupString : BluePrint_GroupString
    {
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_RemoveAt_GroupString GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_RemoveAt_GroupString();
