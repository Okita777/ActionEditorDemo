...
{
    [System.Serializable]
    public class GraphEvent_NoValue_Unit : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_Unit m_BluePrint_Val = new GraphEvent_Value_SelfUnit();
        ...
        public BluePrint_Unit BluePrint_Val
        {
            get
            {
#if UNITY_EDITOR
                if (m_BluePrint_Val is null) m_BluePrint_Val = new GraphEvent_Value_SelfUnit();
#endif
                return m_BluePrint_Val;
            }
        ...
        public TargetUnit value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        public GraphEvent_NoValue_Unit Clone()
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_Unit clone = new GraphEvent_NoValue_Unit();
            clone.BluePrint_Val = (BluePrint_Unit)m_BluePrint_Val.Clone();
