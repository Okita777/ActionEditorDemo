...
{
    [System.Serializable]
    public class GraphEvent_Value_GroupTransform : BluePrint_GroupTransform
    {
        [SerializeField] protected int m_ListLength;
        [System.NonSerialized] private List<Transform> m_ListVal;
        ...
        public override List<Transform> value => m_ListVal;
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            Transform t = part.ActionStateMachine.CurUnit.transform;
            m_ListVal = EngineResourcesManager.Instance.CreateTransforms();
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Value_GroupTransform _graphEvent = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Value_GroupTransform();
