...
{
    [System.Serializable]
    public class GraphEvent_NoValue_String : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_String m_BluePrint_Val = new GraphEvent_Value_String();
        ...
        [EditorGraphProperty("String", true, EditorGraphPropertyType.EEPT_String)]
        public BluePrint_String BluePrint_Val
        {
        ...
        public string value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        public GraphEvent_NoValue_String Clone()
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_String clone = new GraphEvent_NoValue_String();
            clone.BluePrint_Val = (BluePrint_String)m_BluePrint_Val.Clone();
