...
{
    [System.Serializable]
    public class GraphEvent_NoValue_Vector3 : INodeEdiDataHolder
    {
        ...
        public Vector3 value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_Vector3 clone = new GraphEvent_NoValue_Vector3();
            clone.BluePrint_Val = (BluePrint_Vector3)m_BluePrint_Val.Clone();
