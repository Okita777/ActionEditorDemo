...
{
    [System.Serializable]
    public class GraphEvent_NoValue_GroupUnit : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_GroupUnit m_BluePrint_Val = new GraphEvent_Value_GroupUnit();
        ...
        #region Property
        [EditorGraphProperty("UnitGroup", true, EditorGraphPropertyType.EEPT_GroupUnit)]
        public BluePrint_GroupUnit BluePrint_Val
        {
        ...
        public List<ActionEngine_Unit> value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        public GraphEvent_NoValue_GroupUnit Clone()
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_GroupUnit clone = new GraphEvent_NoValue_GroupUnit();
            clone.BluePrint_Val = (BluePrint_GroupUnit)m_BluePrint_Val.Clone();
