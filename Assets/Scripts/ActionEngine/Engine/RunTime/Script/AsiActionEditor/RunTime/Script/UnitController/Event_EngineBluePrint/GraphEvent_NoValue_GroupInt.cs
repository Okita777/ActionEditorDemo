...
{
    [System.Serializable]
    public class GraphEvent_NoValue_GroupInt : INodeEdiDataHolder
    {
        [SerializeReference] protected BluePrint_GroupInt m_BluePrint_Val = new GraphEvent_GValue_GGInt();
        ...
        #region Property
        [EditorGraphProperty("GroupInt", true, EditorGraphPropertyType.EEPT_GroupInt)]
        public BluePrint_GroupInt BluePrint_Val
        {
        ...
        public List<int> value(ActionStatePart part, ActionMachineTime _time, bool _isInit = true)
        {
        ...
        public GraphEvent_NoValue_GroupInt Clone()
        {
#if UNITY_EDITOR
            GraphEvent_NoValue_GroupInt clone = new GraphEvent_NoValue_GroupInt();
            clone.BluePrint_Val = (BluePrint_GroupInt)m_BluePrint_Val.Clone();
