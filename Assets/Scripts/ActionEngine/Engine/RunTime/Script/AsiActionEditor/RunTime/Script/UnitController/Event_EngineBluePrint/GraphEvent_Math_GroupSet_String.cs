...
{
    [System.Serializable]
    public class GraphEvent_Math_GroupSet_String : BluePrint_GroupString
    {
        [SerializeReference] protected BluePrint_GroupString m_ListValue = new GraphEvent_GValue_GGString();
        [SerializeReference] protected BluePrint_Int m_Index = new GraphEvent_Value_Int();
        [SerializeReference] protected BluePrint_String m_SetValue = new GraphEvent_Value_String();

        #region Property
        [EditorGraphProperty("GroupString", true, EditorGraphPropertyType.EEPT_GGroupString, LabelWidth = 60)]
        public BluePrint_GroupString ListValue
        {
        ...
        [EditorGraphProperty("Value", true, EditorGraphPropertyType.EEPT_String)]
        public BluePrint_String SetValue
        {
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_GroupSet_String GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_GroupSet_String();
                GraphEventG.ListValue = (BluePrint_GroupString)m_ListValue.Clone();
                GraphEventG.Index = (BluePrint_Int)m_Index.Clone();
                GraphEventG.SetValue = (BluePrint_String)m_SetValue.Clone();
