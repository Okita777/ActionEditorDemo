...

{
    ...
    public class GraphEvent_Math_Select_Bool : BluePrint_Bool

    {
        ...
        [EditorGraphProperty("True", true, EditorGraphPropertyType.EEPT_Bool)]
        ...
        [EditorGraphProperty("False", true, EditorGraphPropertyType.EEPT_Bool)]
        ...
        [System.NonSerialized] protected GraphEvent_Math_Select_Bool _graphEvent = null;
...

        {
...

            {
                ...
                _graphEvent = new GraphEvent_Math_Select_Bool();
