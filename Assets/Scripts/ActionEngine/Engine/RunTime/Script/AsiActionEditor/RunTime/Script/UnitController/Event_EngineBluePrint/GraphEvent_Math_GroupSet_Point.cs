...
{
    [System.Serializable]
    public class GraphEvent_Math_GroupSet_Point : BluePrint_GroupPointData
    {
        [SerializeReference] protected BluePrint_GroupPointData m_ListValue = new GraphEvent_GValue_GGPoint();
        [SerializeReference] protected BluePrint_Int m_Index = new GraphEvent_Value_Int();
        [SerializeReference] protected BluePrint_PointData m_SetValue = new GraphEvent_BValue_Point();

        #region Property
        [EditorGraphProperty("GroupPoint", true, EditorGraphPropertyType.EEPT_GGroupPoint, LabelWidth = 60)]
        public BluePrint_GroupPointData ListValue
        {
        ...
        [EditorGraphProperty("Value", true, EditorGraphPropertyType.EEPT_PointData)]
        public BluePrint_PointData SetValue
        {
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_GroupSet_Point GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_GroupSet_Point();
                GraphEventG.ListValue = (BluePrint_GroupPointData)m_ListValue.Clone();
                GraphEventG.Index = (BluePrint_Int)m_Index.Clone();
                GraphEventG.SetValue = (BluePrint_PointData)m_SetValue.Clone();
