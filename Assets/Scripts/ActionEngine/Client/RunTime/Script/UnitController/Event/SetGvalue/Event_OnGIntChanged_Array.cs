...
{
    [System.Serializable]
    public class Event_OnGIntChanged_Array : IActionEventData, IGValueListenEvent
    {
        [SerializeField] protected EGValueListenKind m_ListenKind = EGValueListenKind.GInt;
        ...
        [EditorProperty("写入GGroupInt", EditorPropertyType.EEPT_GGroupInt)]
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGIntChanged_Array;
        public IActionEventData Creact() => new Event_OnGIntChanged_Array();
        ...
        {
            Event_OnGIntChanged_Array _event = _eventData as Event_OnGIntChanged_Array;
