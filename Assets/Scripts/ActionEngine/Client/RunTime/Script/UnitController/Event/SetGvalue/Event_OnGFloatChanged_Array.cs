...
{
    [System.Serializable]
    public class Event_OnGFloatChanged_Array : IActionEventData, IGValueListenEvent
    {
        [SerializeField] protected EGValueListenKind m_ListenKind = EGValueListenKind.GFloat;
        ...
        [SerializeField] protected GraphEvent_NoValue_GroupFloat m_BluePrint = new GraphEvent_NoValue_GroupFloat();
        [SerializeField] protected GGroupFloat m_WriteGGroupFloat = new GGroupFloat();
        ...
        public GraphEvent_NoValue_GroupFloat BluePrint { get => m_BluePrint; set => m_BluePrint = value; }
        [EditorProperty("写入GGroupFloat", EditorPropertyType.EEPT_GGroupFloat)]
        public GGroupFloat WriteTarget { get => m_WriteGGroupFloat; set => m_WriteGGroupFloat = value; }
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGFloatChanged_Array;
        public IActionEventData Creact() => new Event_OnGFloatChanged_Array();
        ...
        public void Enter(ActionStatePart _actionState, bool _isSingle)
        {
            ...
            void RunWrite()
            {
                ...
                float[] val = m_BluePrint.value(_actionState, EngineResourcesManager.Instance.MachineTime).ToArray();
                m_WriteGGroupFloat.SetValue(targetUnit.ActionStateMachine.FirstStatePart, val);
            }
            switch (m_ListenKind)
            {
        ...
        {
            Event_OnGFloatChanged_Array _event = _eventData as Event_OnGFloatChanged_Array;
            ...
            _event.m_WriteGGroupFloat = (GGroupFloat)m_WriteGGroupFloat.Clone();
