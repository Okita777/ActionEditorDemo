...
{
    [System.Serializable]
    public class Event_OnGIntChanged : IActionEventData, IGValueListenEvent
    {
        ...
        [SerializeField] protected GInt m_WriteGInt = new GInt(0, true);
        ...
        [EditorProperty("写入GInt", EditorPropertyType.EEPT_Int)]
        public GInt WriteTarget { get => m_WriteGInt; set => m_WriteGInt = value; }
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGIntChanged;
        public IActionEventData Creact() => new Event_OnGIntChanged();
        ...
        public void Enter(ActionStatePart _actionState, bool _isSingle)
        {
            ...
            void RunWrite()
            {
                ...
                m_WriteGInt.SetValue(targetUnit.ActionStateMachine.FirstStatePart, val);
            }
            switch (m_ListenKind)
            {
        ...
        {
            Event_OnGIntChanged _event = _eventData as Event_OnGIntChanged;
            ...
            _event.m_WriteGInt = (GInt)m_WriteGInt.Clone();
