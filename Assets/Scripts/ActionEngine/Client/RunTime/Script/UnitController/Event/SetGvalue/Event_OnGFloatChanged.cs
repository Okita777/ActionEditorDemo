...
{
    [System.Serializable]
    public class Event_OnGFloatChanged : IActionEventData, IGValueListenEvent
    {
        ...
        [SerializeField] protected GraphEvent_NoValue_Float m_BluePrint = new GraphEvent_NoValue_Float();
        [SerializeField] protected GFloat m_WriteGFloat = new GFloat(0, true);
        ...
        public GraphEvent_NoValue_Float BluePrint { get => m_BluePrint; set => m_BluePrint = value; }
        [EditorProperty("写入GFloat", EditorPropertyType.EEPT_Float)]
        public GFloat WriteTarget { get => m_WriteGFloat; set => m_WriteGFloat = value; }
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGFloatChanged;
        public IActionEventData Creact() => new Event_OnGFloatChanged();
        ...
        public void Enter(ActionStatePart _actionState, bool _isSingle)
        {
            ...
            void RunWrite()
            {
                ...
                float val = m_BluePrint.value(_actionState, EngineResourcesManager.Instance.MachineTime);
                m_WriteGFloat.SetValue(targetUnit.ActionStateMachine.FirstStatePart, val);
            }
            switch (m_ListenKind)
            {
        ...
        {
            Event_OnGFloatChanged _event = _eventData as Event_OnGFloatChanged;
            ...
            _event.m_WriteGFloat = (GFloat)m_WriteGFloat.Clone();
