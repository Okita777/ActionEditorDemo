...
{
    [System.Serializable]
    public class Event_OnGEnumChanged : IActionEventData, IGValueListenEvent
    {
        ...
        [SerializeField] protected GraphEvent_NoValue_Int m_BluePrint = new GraphEvent_NoValue_Int();
        [SerializeField] protected GEnum m_WriteGEnum = new GEnum(0, true);
        ...
        public GraphEvent_NoValue_Int BluePrint { get => m_BluePrint; set => m_BluePrint = value; }
        [EditorProperty("写入GEnum", EditorPropertyType.EEPT_Enum)]
        public GEnum WriteTarget { get => m_WriteGEnum; set => m_WriteGEnum = value; }
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGEnumChanged;
        public IActionEventData Creact() => new Event_OnGEnumChanged();
        ...
        public void Enter(ActionStatePart _actionState, bool _isSingle)
        {
            ...
            void RunWrite()
            {
                ...
                int val = m_BluePrint.value(_actionState, EngineResourcesManager.Instance.MachineTime);
                m_WriteGEnum.SetValue(targetUnit.ActionStateMachine.FirstStatePart, (byte)val);
            }
            switch (m_ListenKind)
            {
        ...
        {
            Event_OnGEnumChanged _event = _eventData as Event_OnGEnumChanged;
            ...
            _event.m_WriteGEnum = (GEnum)m_WriteGEnum.Clone();
