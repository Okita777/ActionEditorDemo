...
{
    [System.Serializable]
    public class Event_OnGUnitChanged_Array : IActionEventData, IGValueListenEvent
    {
        [SerializeField] protected EGValueListenKind m_ListenKind = EGValueListenKind.GUnit;
        ...
        [SerializeField] protected GraphEvent_NoValue_GroupUnit m_BluePrint = new GraphEvent_NoValue_GroupUnit();
        [SerializeField] protected GGroupUnit m_WriteGGroupUnit = new GGroupUnit();
        ...
        public GraphEvent_NoValue_GroupUnit BluePrint { get => m_BluePrint; set => m_BluePrint = value; }
        [EditorProperty("写入GGroupUnit", EditorPropertyType.EEPT_GGroupUnit)]
        public GGroupUnit WriteTarget { get => m_WriteGGroupUnit; set => m_WriteGGroupUnit = value; }
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGUnitChanged_Array;
        public IActionEventData Creact() => new Event_OnGUnitChanged_Array();
        ...
        public void Enter(ActionStatePart _actionState, bool _isSingle)
        {
            ...
            void RunWrite()
            {
                ...
                List<ActionEngine_Unit> val = m_BluePrint.value(_actionState, EngineResourcesManager.Instance.MachineTime);
                m_WriteGGroupUnit.SetValue(targetUnit.ActionStateMachine.FirstStatePart, val);
            }
            switch (m_ListenKind)
            {
        ...
        {
            Event_OnGUnitChanged_Array _event = _eventData as Event_OnGUnitChanged_Array;
            ...
            _event.m_WriteGGroupUnit = (GGroupUnit)m_WriteGGroupUnit.Clone();
