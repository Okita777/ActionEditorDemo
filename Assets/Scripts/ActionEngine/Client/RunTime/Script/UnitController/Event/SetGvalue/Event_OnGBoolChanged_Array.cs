...
{
    [System.Serializable]
    public class Event_OnGBoolChanged_Array : IActionEventData, IGValueListenEvent
    {
        ...
        [SerializeField] protected GraphEvent_NoValue_GroupBool m_BluePrint = new GraphEvent_NoValue_GroupBool();
        [SerializeField] protected GGroupBool m_WriteGGroupBool = new GGroupBool();
        ...
        public GraphEvent_NoValue_GroupBool BluePrint { get => m_BluePrint; set => m_BluePrint = value; }
        [EditorProperty("写入GGroupBool", EditorPropertyType.EEPT_GGroupBool)]
        public GGroupBool WriteTarget { get => m_WriteGGroupBool; set => m_WriteGGroupBool = value; }
        ...
        public int GetEvenType() => (int)EEvenType.EET_OnGBoolChanged_Array;
        public IActionEventData Creact() => new Event_OnGBoolChanged_Array();
        ...
        public void Enter(ActionStatePart _actionState, bool _isSingle)
        {
            ...
            void RunWrite()
            {
                ...
                bool[] val = m_BluePrint.value(_actionState, EngineResourcesManager.Instance.MachineTime).ToArray();
                m_WriteGGroupBool.SetValue(targetUnit.ActionStateMachine.FirstStatePart, val);
            }
            switch (m_ListenKind)
            {
        ...
        {
            Event_OnGBoolChanged_Array _event = _eventData as Event_OnGBoolChanged_Array;
            ...
            _event.m_WriteGGroupBool = (GGroupBool)m_WriteGGroupBool.Clone();
