...
namespace AsiActionEngine.RunTime.Graph
{
    [System.Serializable]
    //带参的Vector3
    public class GraphEvent_Math_For_GroupTransform : BluePrint_GroupTransform
    {
        [SerializeReference] protected BluePrint_GroupTransform m_GroupValue = new GraphEvent_GValue_GGTransform();
        ...
        public BluePrint_GroupTransform GroupVal
        {
        ...
        [System.NonSerialized] private List<Transform> m_ReturnVal = null;
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_For_GroupTransform GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_For_GroupTransform();
                GraphEventG.GroupVal = (BluePrint_GroupTransform)m_GroupValue.Clone();
