...
{
    [System.Serializable]
    public class GraphEvent_Math_For_GroupFloat : BluePrint_GroupFloat
    {
        [SerializeReference] protected BluePrint_GroupFloat m_GroupValue = new GraphEvent_GValue_GGFloat();
        ...
        public BluePrint_GroupFloat GroupVal
        {
        ...
        [System.NonSerialized] private List<float> m_ReturnVal = null;
...
#if UNITY_EDITOR
        [System.NonSerialized] protected GraphEvent_Math_For_GroupFloat GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_For_GroupFloat();
                GraphEventG.GroupVal = (BluePrint_GroupFloat)m_GroupValue.Clone();
