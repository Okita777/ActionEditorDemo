...
{
    [System.Serializable]
    public class GraphEvent_TrackData_GetSkillToTag : BluePrint_GroupUnit
    {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            {
                if (ActionEngineManager_Unit.Instance.TryGetSkillToTag(idKey, out List<ActionEngine_Skill> _list))
                {
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_TrackData_GetSkillToTag GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_TrackData_GetSkillToTag();
