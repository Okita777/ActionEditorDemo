...
{
    [System.Serializable]
    public class GraphEvent_Math_Add_GroupUnit_Unit : BluePrint_GroupUnit
    {
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            {
                if (!m_ReturnVal.Contains(m_InVal2.value)) m_ReturnVal.Add(m_InVal2.value.GetUnit());
            }
        }
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_Add_GroupUnit_Unit GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_Add_GroupUnit_Unit();
