...
namespace AsiActionEngine.RunTime.Graph
{
    [System.Serializable]
    //带参的Vector3
    public class GraphEvent_Math_RangeAngle_GGPoint : BluePrint_GroupPointData
    {
        ...
        #region Property
        [EditorGraphProperty("GroupPoint", true, EditorGraphPropertyType.EEPT_GGroupPoint, LabelWidth = 70)]
        ...
        public override void Init(ActionStatePart part, ActionMachineTime _time)
        {
            ...
            if (IsDebug.value)
            {
                ...
                //if (m_IsRefer)
                //{
                //    EngineDebug.DrawSolidArc(AxisType.value, m_ReferAxis.value,
                //        m_TargetPos.value, Distance.value, Radius.value, m_Color, Delay.value);
                //}
                //else
                //{
                //    EngineDebug.DrawSolidArc(AxisType.value, Vector3.up,
                //        m_TargetPos.value, Distance.value, Radius.value, m_Color, Delay.value);
                //}
            }
#endif
            ...
            if (m_IsRefer)
            {
                ...
                {
                    m_TargetAxis = m_ReturnVal[i].pos - AxisType.value;
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_RangeAngle_GGPoint GraphEventG = null;
#endif
        ...
        public override BluePrint_Value Clone()
        {
            ...
            {
                GraphEventG = new GraphEvent_Math_RangeAngle_GGPoint();
